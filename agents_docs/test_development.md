...
- Hooking scanning and big-update routines while a test runs lets you correlate `mock.performance` tick spikes with processed tiles, queue deltas, and budget spend, which explains long max-tick durations.
